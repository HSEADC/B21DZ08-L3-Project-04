class PostsController < ApplicationController
  ...
  private
    ...
    def post_params
      params.require(:post).permit(:title, :text, :draft, :context, :people, :recording_date, :place, :remark, :source, :kind_list, :language_list, :nationality_list, :theme_list,).merge(user_id: current_user.id)
    end
end
