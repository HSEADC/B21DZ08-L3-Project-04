class RepliesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @reply.save
        format.html { redirect_to post_url(@parent_comment.post), notice: "Comment was successfully created." }
        format.json { render :show, status: :created, location: @reply }
      else
        format.html { render partial: 'comments/comment', locals: { comment: @parent_comment, reply: @reply }, status: :unprocessable_entity }
